...
Se muestra una lista de productos disponible para la venta:

![image](https://github.com/user-attachments/assets/6c5478e1-24a0-4bbe-908a-aca94a403b0e)

Los productos se cargan de cinco en cinco. Podemos presionar **ENTER** para ver más o escribir cualquier otra cosa para volver al menú principal.

---

### Opción 2: Registro de usuario

Permite registrar un nuevo usuario con verificación por correo electrónico.
...
Se puede acceder como **administrador**, **trabajador** o **cliente**.
...
Una vez dentro, tenemos acceso completo a todas las funcionalidades del programa.  
Se muestra la fecha del último inicio de sesión, estadísticas generales y un menú con múltiples opciones.

![image](https://github.com/user-attachments/assets/6aee1bd9-35cf-40ec-80af-70128d1b178e)

### Opción 1: Catálogo de productos  
Permite visualizar y buscar productos por distintos criterios.

![image](https://github.com/user-attachments/assets/e3ab247a-7208-464f-9644-1bd13a7207a2)

### Opción 2: Modificar producto  
Editar cualquier campo de un producto a partir de su ID.
...
Visualización de los datos de trabajadores.
...
Actualiza pedidos y notifica al cliente por correo.
...
Asignación con notificación por correo y Telegram.
...
Envía un Excel con todos los pedidos registrados.
...
Crear y restaurar backups, con posibilidad de elegir ruta.
...
Igual que en el menú administrador.

### Opción 4: Editar producto  
Si tiene permisos, puede editar productos también.
